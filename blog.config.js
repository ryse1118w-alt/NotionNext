...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '瘋速修', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '高雄在地手機維修，快速．專業．可靠', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://crazyquickfix.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '手機維修, iPhone維修, 高雄維修, Apple授權維修, 草衙, 鳳山, 小港, 五甲', // 网站关键词 英文逗号隔开
